...
#### Read data from file ####
file_data = pd.read_csv("wfp_food_prices_uganda.csv")

#print(file_data.head())
print(file_data.head())

#### Remove the first row since it contains irrelevant values ####
...
commodity = file_data[file_data.cmname.str.contains('Beans - Retail')]
commodity = commodity[commodity.mktname == 'Makaratin']

#### Display the top 5 rows of the filtered commodity data ####
print(commodity.head())

#### Print the length of the filtered data we have ####
print(len(commodity))
